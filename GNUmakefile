...
System2.iso:
	...
	xorriso -as mkisofs -b limine-cd.bin \
		...
		iso_root -o System2.iso
		
	limine/limine-deploy System2.iso
	rm -rf iso_root
...
clean: clean2
	@rm -rf iso_root System2.iso barebones.hdd ./external/programs.saf
...
ccar:
	...
	make -j$(nproc)
	qemu-system-x86_64 -machine q35 -m 2G -cpu qemu64 -smp 4 -serial stdio -boot d -cdrom System2.iso -no-reboot --no-shutdown
