#ifndef OS_DRIVE_E1000_H
#define OS_DRIVE_E1000_H
...
public:
    ...
    E1000(PCI::PCIDeviceHeader * p_pciConfigHeader); // Constructor. takes as a parameter a pointer to an object that encapsulate all he PCI configuration data of the device
    void start ();                             // perform initialization tasks and starts the driver
    void fire (interrupt_frame* frame);  // This method should be called by the interrupt handler 
